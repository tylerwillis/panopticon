...
# 2119: attached-session-image-paste.2.1
...
# 2119: attached-session-image-paste.3.2
# 2119: attached-session-image-paste.4.1
...
def test_each_failure_reports_workaround_without_pasting_a_path() -> None:
    for failure in ("capture", "empty", "oversize", "staging", "loading", "delivery"):
        ...
        if failure in {"capture", "empty", "oversize", "staging", "loading"}:
