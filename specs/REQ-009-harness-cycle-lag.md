# REQ-009: New-task harness suggestion responsiveness
...
### REQ-009.2: One discovery per harness
...
### REQ-009.4: Early-cycle fallback
...
### REQ-009.5: Cached cycle latency
...
### REQ-009.7: No post-close update
