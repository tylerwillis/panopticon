...
### REQ-026.2: Composed container status
...
### REQ-026.3: Held dashboard presentation
...
1. For any task with at least one non-terminal dependency and no attention marker, the dashboard
   ...
   the `held N` form from REQ-026.5 when the governor rule also applies.
...
### REQ-026.4: Dependency graph policy
...
### REQ-026.5: Governor held presentation
...
### REQ-026.6: Attention can only escalate
