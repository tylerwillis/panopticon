...
### REQ-025.2: Composed container status
...
### REQ-025.3: Held dashboard presentation
...
1. For any task with at least one non-terminal dependency and no attention marker, the dashboard
   ...
   the `held N` form from REQ-025.5 when the governor rule also applies.
...
### REQ-025.4: Dependency graph policy
...
### REQ-025.5: Governor held presentation
...
### REQ-025.6: Attention can only escalate
