# REQ-034: Safe cross-host task migration
...
### REQ-034.1: Host-qualified provisioning
...
### REQ-034.2: Destination workspace correctness
...
### REQ-034.3: Explicit claim movement
...
### REQ-034.4: Uncommitted and unpushed work
...
### REQ-034.5: Workspace transfer integrity
...
### REQ-034.6: Session history, credentials, and containers
...
### REQ-034.7: Failure-safe execution gate
