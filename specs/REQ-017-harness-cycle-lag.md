# REQ-017: New-task harness suggestion responsiveness
...
### REQ-017.2: One discovery per harness
...
### REQ-017.4: Early-cycle fallback
...
### REQ-017.5: Cached cycle latency
...
### REQ-017.7: No post-close update
