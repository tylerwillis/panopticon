# REQ-001: New-task harness suggestion responsiveness
...
### REQ-001.2: One discovery per harness
...
### REQ-001.4: Early-cycle fallback
...
### REQ-001.5: Cached cycle latency
...
### REQ-001.7: No post-close update
