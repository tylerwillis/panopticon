# REQ-043: Environmental spawn failure recovery
...
### REQ-043.2: Post-session launcher failures remain latched
...
1. An agent-launcher lifecycle failure reported after the task tmux session is established MUST
   ...
   task's claim.
2. While the claim for a task covered by REQ-043.2.1 remains held,
...
### REQ-043.3: Classification boundary
